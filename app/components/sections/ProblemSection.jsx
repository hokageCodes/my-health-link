  ...
  const problems = [
    {
      ...
      description: "Health records scattered across multiple platforms and hospitals",
      color: "text-red-400",
    ...
    },
    {
      ...
      description: "Retaking expensive tests because you can't find the results or information about when last it was taken",
      color: "text-red-400",
      bgColor: "bg-red-400/10",
    },
    {
      ...
      description: "Sending multiple images to doctors, hoping nothing gets missed",
    ...
    },
    {
      ...
      description: "Critical health info unavailable when you need it most",
